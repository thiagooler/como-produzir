// Configuração Central de Preços e Produtos - Studio NBV
const DB_CONFIG = {
    album: {
        incluso: 0,
        extra: 15.00
    ...
    calculo: {
        markup: 2.5,
        custoFixo: 30.00,
        regras: { '15x20':2, '20x30':4, '30x40':5 },
        tabela: [
    ...
    produtos: [
        {nome:"Foto 10x15", preco:10.00},
        {nome:"Foto 15x20", preco:20.00},
        {nome:"Foto 20x30", preco:30.00},
        {nome:"Foto 30x40", preco:40.00},
        {nome:"Foto 40x60", preco:60.00},
        {nome:"Porta retrato 10x15", preco:20.00},
        {nome:"Porta retrato 15x20", preco:35.00},
        {nome:"Porta retrato 20x30", preco:45.00},
        {nome:"Porta retrato 30x40", preco:120.00},
        {nome:"Porta retrato 40x60", preco:290.00},
        {nome:"Arquivo Digital", preco:8.00}
    ],
    creditos: [
        // {nome:"Arquivo Digital", qtd:10} // Exemplo
    ]
};
